-- Optional quantity; no stock mutations. Existing audit/version/idempotency guards retained.
alter table public.purchase_needs add column quantity_needed numeric(14,3)
 check (quantity_needed between 0 and 99999999999.999);
