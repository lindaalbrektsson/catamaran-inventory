...
('20000000-0000-4000-8000-000000000005','Maintenance','Mantenimiento'),
('20000000-0000-4000-8000-000000000006','Cleaning','Limpieza'),
('20000000-0000-4000-8000-000000000007','Spare Parts','Repuestos'),
('20000000-0000-4000-8000-000000000008','Tools','Herramientas') on conflict do nothing;
...
('30000000-0000-4000-8000-000000000006','Paper Towels','20000000-0000-4000-8000-000000000006','roll'),
('30000000-0000-4000-8000-000000000007','Trash Bags','20000000-0000-4000-8000-000000000006','pack'),
('30000000-0000-4000-8000-000000000008','Snorkel Masks','20000000-0000-4000-8000-000000000004','piece') on conflict do nothing;
-- No balance rows, thresholds, costs, movements, expenses or Auth users are seeded.
-- Owners explicitly configure each product/location through configure_inventory.
